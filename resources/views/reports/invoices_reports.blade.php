        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                    ...
                    {{-- <input type="radio" class="btn-check" name="rdio" value="1" id="type_div" autocomplete="off" checked>
                    <label class="btn btn-secondary" for="option1">بحث بنوع الفاتورة</label>
                    
                    <input type="radio" class="btn-check" name="rdio" value="2"   autocomplete="off">
                    <label class="btn btn-secondary" for="option2">بحث برقم الفاتورة</label>
                     --}}
