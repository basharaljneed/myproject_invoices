            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/6.avif') }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'dashboard')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الرئيسيّة</span>
                </a>
            </li>
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_paid')) }}">الفواتير المدفوعة
                                    كلياَ</a>
                            </li>
                        @endcan()

                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_unpaid')) }}">الفواتير غير
                                    المدفوعة</a>
                            </li>
                        @endcan()

                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_partpaid')) }}">الفواتير المدفوعة
                                    جزئياً</a></li>
                        @endcan()

                        @can('أرشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_archif')) }}">أرشيف الفواتير </a>
                            </li>
                        @endcan()
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'CustomersReports')) }}">تقارير العملاء</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('المستخدمين')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">المستخدمين</span>
                    </a>
                    <ul class="slide-menu">
