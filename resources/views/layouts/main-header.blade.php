    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ url('/' . ($page = 'index')) }}"><img src="{{ URL::asset('assets/img/brand/6.avif') }}"
                            ...
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    <span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                        <a id="unreadNotificationuser" href="{{ route('markread') }}">
                                            قراءة الكل
                                        </a>
                                ...
                                <p id="countNotification"
                                    class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                                    عدد الرسائل :{{ auth()->user()->unreadNotifications->count() }}
                                </p>

                            </div>

                            <div id="unreadNotification" class="main-notification-list Notification-scroll">
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <a class="d-flex p-3 border-bottom"
                                        href="{{ url('invoicedet') }}/{{ $notification->data['xx'] }}">
